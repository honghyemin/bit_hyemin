...
public class ArrayListTest02 {
    ...
    public static void main(String[] args) {
        ...
        // 포함관계
        System.out.println("list컬렉션에 list2컬렉션의 모든 요소가 들어있는가?---> ");
        System.out.println(list1.containsAll(list2)); // boolean타입
        System.out.println();
        
        // 추가하기 - 위에 ArrayList<Integer> list2를 오브젝트타입으로 변경함. -> ArrayList list2
        list2.add("B"); // 배열 복사가 일어나지 않음 (뒤로 추가됨.)
        list2.add("C"); // 배열 복사가 일어나지 않음
        print(list1, list2);
        
        list2.add(3, "A");  // 배열 복사가 일어남 (특정 위치를 지정해서 추가함)
        print(list1, list2);
