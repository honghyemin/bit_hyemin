...
// 다음은 클래스 작성시 주의할 사항인데 이 중 틀린 것을 말해보시오.

// (1) 하나의 파일에 2개 이상의 클래스를 작성할 수 있다.
// (2) 3개의 클래스가 있다면 자바 파일명이 될 수 있는 것은 public키워드가 붙은 클래스이다.
// (3) 하나의 파일에 있는 3개의 클래스에 모두 public 키워드를 붙일 수 있다. x => public이 붙은 '클래스'하나만 가능. 
